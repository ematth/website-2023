...
{MS in Computer Science}{August 2023 - (Graduating May 2025)}
\resumeItemListStart
\item Area: Artificial Intelligence
\item GPA: 3.33/4.00
\item Thesis: \textbf{\textit{Audio Generation Improvement through Text Prompt Recaptioning}}

Description of thesis here!
\item Advisor: Prof. Paris Smaragdis
\item Selected Courses: Machine Learning for Computer Vision, Machine Learning for Signal Processing, Data Mining, Numerical Analysis, Topics in Computer Education 
\resumeItemListEnd

\resumeSubheading
{University of Illinois Urbana-Champaign}{Urbana, IL}
{BS in Computer Science + Music}{August 2019 - May 2023}
\resumeItemListStart
\item GPA: 3.76/4.00
\item Capstone Advisor: Prof. Zuofu Cheng
\item Selected Courses: Artificial Intelligence, Database Systems, Algorithms \& Models of Computation, Systems Architecture, Data Structures, Computation and Music, Electroacoustic Techniques
\resumeItemListEnd
...
\resumeItemListStart
\item High Honors, National Honor Society
\item GPA: 3.93/4.00
\resumeItemListEnd
...
\item[\textbf{[T.1]}] \textbf{Evan Matthews}. (ongoing). \text{"Audio Generation Improvement through Text Prompt Recaptioning"}.

\item[\textbf{[S.1]}] Yuxuan Chen, Victor Zhao, \textbf{Evan Matthews}, Craig Zilles, Matthew West (2024). \href{}{\text{"Bayesian Grading: Analysis of Scores in the Context of Cheating"}}. %In \textit{SIGCSE Virtual Conference 2024}, pp. XX-XX. Publisher. Date, Location. DOI: XX.XXXX/XXXXXXX.XXXX.XXXXXXX
